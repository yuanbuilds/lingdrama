        ...
        <div class="settings-head">
          <div class="settings-brand">
            <div class="settings-brand-mark">
              <img v-if="showBrandImage" :src="brandLogo" alt="灵动 LingDrama" class="settings-brand-logo" @error="showBrandImage = false" />
              <span v-else class="settings-brand-fallback">灵</span>
            </div>
            <div class="settings-brand-copy">
              <div class="settings-brand-kicker">LingDrama</div>
              <div class="settings-brand-name">灵动</div>
            </div>
          </div>
...
const providers = ['ali', 'gemini', 'minimax', 'openai', 'openrouter', 'vidu', 'volcengine']
...
const providerPresets = {
  text: {
    openrouter: { label: 'OpenRouter', baseUrl: 'https://openrouter.ai/api', models: ['google/gemini-3-flash-preview'] },
    openai: { label: 'OpenAI', baseUrl: 'https://api.openai.com', models: ['gpt-4.1-mini'] },
  },
  image: {
    gemini: { label: 'Gemini', baseUrl: 'https://generativelanguage.googleapis.com', models: ['gemini-3-pro-image-preview'] },
    volcengine: { label: 'Volcengine', baseUrl: 'https://ark.cn-beijing.volces.com', models: ['doubao-seedream-4-0-250828'] },
  },
  video: {
    openai: { label: 'OpenAI Compatible', baseUrl: 'https://api.openai.com', models: ['sora-2'] },
    volcengine: { label: 'Volcengine', baseUrl: 'https://ark.cn-beijing.volces.com', models: ['doubao-seedance-1-5-pro-251215'] },
    vidu: { label: 'Vidu', baseUrl: 'https://api.vidu.com', models: ['viduq3-turbo'] },
    ali: { label: 'Alibaba Cloud', baseUrl: 'https://dashscope.aliyuncs.com', models: ['wan2.6-i2v-flash'] },
  },
  audio: {
    minimax: { label: 'MiniMax', baseUrl: 'https://api.minimax.io', models: ['speech-2.8-hd'] },
  },
}
...
function applyProviderPreset(type, provider) {
  ...
  cfgForm.name = `${preset.label}-${translateText(serviceMeta[type].label, getLingLocale())}`
}
